...
#
# Claude Code SessionStart hooks accept plain-text stdout OR the documented
# JSON schema below. Any other JSON shape is valid-but-unrecognized and gets
# silently ignored, so we must emit exactly this:
