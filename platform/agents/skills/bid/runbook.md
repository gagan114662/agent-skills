...
kind: runbook
version: 1.0.0
description: The senior Ads practitioner procedure for @bid — clarify, consult governed sources first, execute, self-review.
---
...
Because @bid's work can leave the building, **never** send, post, or spend. Produce the **draft** plus a
