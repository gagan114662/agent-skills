 ...
 * neither Postgres nor the onboarding service — it streams a deliverable derived purely from the URL — so
 * stub deps satisfy the registration signature. Pacing is disabled so `inject` collects the full stream.
 */
